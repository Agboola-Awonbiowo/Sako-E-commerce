    ...
    <>
      ...
      >
        <Flex mb={10} justify="space-between">
          <Box>
            <HStack isInline>
              <Text letterSpacing="wide" fontSize="lg" fontWeight="extrabold">
                Bag
              </Text>
              <Tag bg="#3182CE" variant="solid" fontSize="lg">
                {props.item.cart.length}
              </Tag>
            </HStack>
          </Box>
          <Box cursor="pointer">
        ...
        {cart.length > 0 && (
          <Box>
            ...
            <Box color="#48BB78" fontSize="sm" fontWeight="bold">
              Your about to save UGX 27.400 on this order
            </Box>
          </Box>
        )}
      </Box>
